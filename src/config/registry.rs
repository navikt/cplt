...
pub(super) const CONFIG_KEYS: &[ConfigKeyInfo] = &[
    ...
    ConfigKeyInfo {
        ...
        dangerous: true,
        default_display: "[]",
        description: "\u{26a0}\u{fe0f}  DANGEROUS: Trees the agent may execute binaries from (e.g. a relocated Homebrew prefix). Read + execute, never write. Refused for /, $HOME, and any tree that overlaps a writable one \u{2014} writable + executable is a binary-drop path.",
    },
    ConfigKeyInfo {
        section: "allow",
        key: "socket",
